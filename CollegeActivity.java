...
public class CollegeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button002 = (Button) findViewById(R.id.button6);
        LV5 = findViewById(R.id.lv5);
        LV5.setAdapter(new collegelistAdpter(CollegeActivity.this));
        Button002.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(CollegeActivity.this,MainActivity.class);
